...
// Using standard div/classes instead of framer-motion to ensure rendering
export default function LoginPage() {
    const handleLogin = (provider: string) => {
        signIn(provider, { callbackUrl: '/experienz' });
    };
    ...
    return (
        <div className="min-h-screen bg-[#060914] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-[#0B101F]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative z-10">
